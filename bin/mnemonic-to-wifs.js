...
async function main() {
  ...
  if (!mnemonicPath) {
    ...
    console.error("Usage:");
    console.error(
      "        mnemonic-to-wifs <./mnemonic.txt> [./password.txt] [fromPath] [toPath]",
    );
    console.error("");
    ...
    console.error('        mnemonic-to-wifs ./mnemonic.txt "" "5" "15"');
    console.error("");
    console.error("        # these are all EQUIVALENT");
    console.error('        mnemonic-to-wifs ./mnemonic.txt ./pw.txt "5" "15"');
    console.error(
      '        mnemonic-to-wifs ./mnemonic.txt ./pw.txt "0/5" "15"',
    );
    console.error(
      '        mnemonic-to-wifs ./mnemonic.txt ./pw.txt "0/5" "0/15"',
    );
    console.error(
      '        mnemonic-to-wifs ./mnemonic.txt ./pw.txt "0\'/0/5" "15"',
    );
    console.error(
      '        mnemonic-to-wifs ./mnemonic.txt ./pw.txt "m/44\'/5\'/0\'/0/5" "15"',
    );
    console.error(
      "        mnemonic-to-wifs ./mnemonic.txt ./pw.txt \"m/44'/5'/0'/0/5\" \"m/44'/5'/0'/0/15\"",
    );
    console.error("");
    console.error(
      '        mnemonic-to-wifs ./mnemonic.txt ./pw.txt "m/44\'/5\'/0\'/0/0" "10"',
    );
    console.error(
      "        mnemonic-to-wifs ./mnemonic.txt ./pw.txt \"m/44'/5'/0'/0/0\" \"1'/10\"",
    );
    console.error(
      "        mnemonic-to-wifs ./mnemonic.txt ./pw.txt \"m/44'/5'/0'/0/0\" \"3'/1/5\"",
    );
    console.error("");
    process.exit(1);
  }
