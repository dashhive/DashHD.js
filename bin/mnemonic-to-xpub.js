  ...
  if (!mnemonicPath) {
    console.error(
      [
        "",
        "Usage",
        "        mnemonic-to-xpub <./mnemonic.txt> [./password.txt] [hdpath]",
        "",
        "Examples",
        "        # '/'-suffixed paths will assume the default prefix",
        "        # (these are all equivalent)",
        '        mnemonic-to-xpub ./mnemonic.txt ./password.txt "/0"',
        '        mnemonic-to-xpub ./mnemonic.txt ./password.txt "/0\'/0"',
        "        mnemonic-to-xpub ./mnemonic.txt ./password.txt \"m/44'/5'/0'/0\"",
        "",
        "        # 'm'-prefixed paths will be used exactly (allowing broad xkeys)",
        "        # (each of these are different)",
        "        mnemonic-to-xpub ./mnemonic.txt ./password.txt \"m/44'/5'/0'/0\"",
        "        mnemonic-to-xpub ./mnemonic.txt ./password.txt \"m/44'/5'/0'\"",
        "        mnemonic-to-xpub ./mnemonic.txt ./password.txt \"m/44'/5'\"",
        "",
        "IMPORTANT",
